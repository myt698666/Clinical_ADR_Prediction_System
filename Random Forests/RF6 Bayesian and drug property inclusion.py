...
input_file_path = "Drug Information/pubchem_data_merged.csv"
...
for target in selected_targets:#output_columns:
    ...
    with open(f"Random Forests/Best Models/{target}_best_params_drug_property.json", "w") as f:
        json.dump(best_params, f, indent=4)

with open("best_params_inc_prop.json", "w") as f:
    json.dump(best_params, f, indent=4)
