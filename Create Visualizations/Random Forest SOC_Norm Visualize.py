...
for target in output_columns:
    ...
    for random_state in [10, 20, 42, 57, 83]:
        model_filename = f"saved_models/SOC_Norm/random_forest_model_{target}_{random_state}.pkl"
...
for idx, target in enumerate(top_10_targets):
    ...
    # Create bar graph for this comparison
