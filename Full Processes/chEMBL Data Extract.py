...
python_files = ["chEMBL Data Extraction/chEMBL Activity Values.py", "chEMBL Data Extraction/chEMBL Activity Values.py"]

# CSV file to store results
output_csv = "Timings/chEMBL Extraction Execution Times.csv"
