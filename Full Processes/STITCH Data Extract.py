...
python_files = ["STITCH_Identifiers/Filter protein chemical interactions.py", "STITCH_Identifiers/Filter 10gb chemical file.py"]

# CSV file to store results
output_csv = "Timings/STITCH Extraction Execution Times.csv"
